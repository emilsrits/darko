...
function mloc_appearance_typography_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section( 'mloc_appearance_typography', array(
        'title'		=> __( 'Typography Settings', 'mloc' ),
...
/**
 * Combine system fonts with Google fonts into one array
 *
 * @return array
 */
...
/**
 * Returns array of web safe fonts
 *
 * @return array
 */
function mloc_get_sys_fonts() {
    return apply_filters(
        ...
        array(
            ...
            '_sys Comic Sans MS' => 'Comic Sans MS, cursive, sans-serif',
            '_sys Courier New' => 'Courier New, Courier, monospace',
            '_sys Georgia' => 'Georgia, serif',
            '_sys Impact' => 'Impact, Charcoal, sans-serif',
            '_sys Lucida Console' => 'Lucida Console, Monaco, monospace',
            '_sys Lucida Sans' => 'Lucida Sans Unicode, Lucida Grande, sans-serif',
            '_sys Palatino Linotype' => 'Palatino Linotype, Book Antiqua, Palatino, serif',
            '_sys Tahoma' => 'Tahoma, Geneva, sans-serif',
            '_sys Times New Roman' => 'Times New Roman, Times, serif',
            '_sys Trebuchet MS' => 'Trebuchet MS, Helvetica, sans-serif',
            '_sys Verdana' => 'Verdana, Geneva, sans-serif',
        )
    );
}

/**
 * Returns array of Google fonts with default system fonts
 *
 * @return array
 */
